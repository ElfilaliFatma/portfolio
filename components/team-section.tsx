        ...
        {teamMembers.map((member, index) => (
          ...
          >
            ...
            <div className="flex justify-center">
              <div
                className={`relative h-24 w-24 overflow-hidden rounded-full ring-4 ring-offset-2 ring-offset-white dark:ring-offset-gray-900 transition-all duration-300 group-hover:ring-opacity-60 ${colorBorderMap[member.color]}`}
              >
                <Image
                  src={member.photo}
